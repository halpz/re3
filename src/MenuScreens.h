...
const CMenuScreen aScreens[] = {
	...
	{ "FET_LG", MENUPAGE_NEW_GAME, MENUPAGE_NEW_GAME, MENUPAGE_NEW_GAME, MENUROW_1, MENUROW_1,
		...
		MENUACTION_CHECKSAVE,	"FEM_SL1", SAVESLOT_1 + 1,	MENUPAGE_LOAD_SLOT_CONFIRM,
		MENUACTION_CHECKSAVE,	"FEM_SL2", SAVESLOT_2 + 1,	MENUPAGE_LOAD_SLOT_CONFIRM,
	...
	{ "FET_DG", MENUPAGE_NEW_GAME, MENUPAGE_NEW_GAME, MENUPAGE_NEW_GAME, MENUROW_2, MENUROW_2,
		MENUACTION_CHANGEMENU, "FESZ_CA", SAVESLOT_NONE,	MENUPAGE_NEW_GAME,
		MENUACTION_CHANGEMENU, "FEM_SL1", SAVESLOT_1 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL2", SAVESLOT_2 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL3", SAVESLOT_3 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL4", SAVESLOT_4 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL5", SAVESLOT_5 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL6", SAVESLOT_6 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL7", SAVESLOT_7 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
		MENUACTION_CHANGEMENU, "FEM_SL8", SAVESLOT_8 + 1,	MENUPAGE_DELETE_SLOT_CONFIRM,
	},
	...
	{ "FET_SG", MENUPAGE_DISABLED, MENUPAGE_DISABLED, MENUPAGE_DISABLED, MENUROW_0, MENUROW_0,
		MENUACTION_UPDATEMEMCARDSAVE,	"FESZ_CA", SAVESLOT_NONE,	MENUPAGE_NONE,
		MENUACTION_CHANGEMENU,			"FEM_SL1", SAVESLOT_1 + 1,	MENUPAGE_SAVE_OVERWRITE_CONFIRM,
		MENUACTION_CHANGEMENU,			"FEM_SL2", SAVESLOT_2 + 1,	MENUPAGE_SAVE_OVERWRITE_CONFIRM,
		...
		MENUACTION_CHANGEMENU,			"FEM_SL6", SAVESLOT_6 + 1,	MENUPAGE_SAVE_OVERWRITE_CONFIRM,
		MENUACTION_CHANGEMENU,			"FEM_SL7", SAVESLOT_7 + 1,	MENUPAGE_SAVE_OVERWRITE_CONFIRM,
		MENUACTION_CHANGEMENU,			"FEM_SL8", SAVESLOT_8 + 1,	MENUPAGE_SAVE_OVERWRITE_CONFIRM,
	},
